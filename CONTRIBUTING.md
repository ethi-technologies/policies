...
Before you decide to open an issue, browse [open issues](https://github.com/ethi-technologies/policies/issues) to see current requests. We also generally want to hear about:
...
[Open an issue](https://github.com/ethi-technologies/policies/issues/new) to tell us about any of the above. You may also open a pull request to propose specific changes, but it's always OK to start with an issue.
...
**NOTE:** Please don't post legal complaints or ask for technical support in this repository. We may not respond to issues or comments promptly. If you need help, email contact@ethi.me and we'll try to answer your questions.
